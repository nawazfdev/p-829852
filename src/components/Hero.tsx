...
const Hero = () => {
  return <section className="relative h-[80vh] min-h-[600px] overflow-hidden">
      {/* Hero Background */}
      <div className="absolute inset-0 bg-gradient-to-r from-primary/10 to-transparent">
        <img src="https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?q=80&w=2053&auto=format&fit=crop" alt="Luxury Real Estate" className="object-cover w-full h-full" loading="eager" />
      ...
      <div className="container relative max-w-7xl mx-auto h-full flex flex-col justify-center px-4">
        <div className="max-w-3xl animate-fade-in">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link to="/properties">
              <Button variant="primary" size="lg" className="ml-2" icon={<ArrowRight size={18} />} iconPosition="right">
                View All Properties
              </Button>
            </Link>
          </div>
